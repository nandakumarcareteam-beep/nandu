...
function StoryScene({ scene, index, scrollYProgress }: StorySceneProps) {
  ...
  return (
    ...
    >
      ...
      {/* Background Glow */}
      <div 
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] pointer-events-none -z-10 opacity-20"
        style={{
